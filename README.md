...
- טעינת דוח כרטיס שואלת תחילה אם הכרטיס בנקאי או חוץ-בנקאי ומי הנפיק אותו — ויזה, כאל, ישראכרט, מקס, לאומי קארד, דיינרס או אמריקן אקספרס — ושומרת את שתי התשובות על התנועות.
- כל שורה בטבלת התנועות מציגה את מקורה: בנק, שם מנפיק הכרטיס, או „הזנה ידנית” לשורה שהוקלדה. שורה שיובאה בלי לציין מנפיק מציגה „כרטיס אשראי” ולא ניחוש.
