...
| `tests/server/test_models.py` | Pydantic allowlists, size bounds, financial-identifier rejection, the card issuer, and a categorisation rule carrying the direction it reads end to end through a snapshot |
