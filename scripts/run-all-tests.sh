...
SCALAR_PORT=${SCALAR_PORT:-18767}
PRODUCTION_URL=${PRODUCTION_URL:-https://home-economy-stabilation.vercel.app}
PRODUCTION_URL=${PRODUCTION_URL%/}
export APP_PORT API_PORT PROMETHEUS_PORT GRAFANA_PORT ALLURE_PORT SCALAR_PORT PRODUCTION_URL
...
compose up --detach api web scalar prometheus grafana || exit $?
...
echo "  Scalar:       $PRODUCTION_URL/scalar-docs.html"
...
echo "  Scalar:      http://127.0.0.1:$SCALAR_PORT/scalar-docs.html"
